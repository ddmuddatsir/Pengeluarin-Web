...
export const IconSearch = ({ color }) => (
  <svg
    ...
    stroke="currentColor"
    className="size-6"
    style={{ color: color, height: 20, width: 20 }}
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const IconRightChevron = ({ color }) => (
  <svg
    ...
    stroke="currentColor"
    className="size-6"
    style={{ color: color, height: 18, width: 18 }}
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const IconChartCakeOutline = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const IconChartCakeSolid = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const IconCalender = () => (
  <svg
    ...
    stroke="currentColor"
    className="size-6"
    style={{ height: 18, width: 18, color: "gray" }}
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
